import meterInterestImage from '../assets/Meter_Interest.png';
import ageCalculator from '../assets/Age_calculator.png';
...
export const projectData = [
    ...
    {
      id: 2,
      title: 'Meter Interest Calculator',
      imageUrl: meterInterestImage,
      description: "The Meter Interest Calculator computes the interest on a given principal amount, rate of interest, and time. It's built using HTML for the structure, CSS for styling, and JavaScript to perform the interest calculation. Users can input the required details, and the calculator returns the calculated interest.",
      altMessage: '',
      link: 'https://bibekkumarkushwaha.com.np/meter_interest1.html',
    },
    {
      id: 3,
      title: 'Grading System Calculator',
      imageUrl: Grade,
